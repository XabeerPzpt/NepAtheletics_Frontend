...
const {user,setIsCardVisible,logout} = useAuth();
        ...
        <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flow-root">
                        <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <li class="py-3 sm:py-4">
                                <div class="flex items-center" className='change_password'>
                                    ...
                                    <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white" className='changePasswordText'>
                                        <Link to='/changePassword' onClick={ChangeCardVisibility} >
                                        Change Password 
                                        </Link>
                                    </div>
                            ...
                            <li class="py-3 sm:py-4">
                                <div class="flex items-center">
                                    <div onClick={logout} class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                        Logout 
                                    </div>    
                                </div>
                            </li>
